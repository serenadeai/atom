...
export default class CommandHandler {
    ...
    async COMMAND_TYPE_CANCEL(data) {
        this.delegate.alternativesPanel.showSuggestions();
    }
    ...
    async COMMAND_TYPE_OPEN_FILE(data) {
        ...
        this.delegate.alternativesPanel.showAlternatives(result.map((e, i) => {
    ...
    async COMMAND_TYPE_SET_EDITOR_STATUS(data) {
        ...
        this.delegate.listening = text != 'Paused';
        this.delegate.alternativesPanel.updateStatus(text);
    }
    ...
    async COMMAND_TYPE_USE(data) {
        ...
        this.delegate.alternativesPanel.highlight(index);
        if (this.delegate.alternativesPanel.filesShowing) {
