...
export default class AlternativesPanel {
    constructor(state, ipc, settings) {
        ...
        this.state.subscribe('installed', (installed) => {
            let $container = this._container.querySelector('.alternatives-volume-container');
            if (installed) {
...
<div class="alternatives">
    ...
    <div class="alternatives-list"></div>
        ...
        this._container.querySelector('.btn-menu').addEventListener('click', (e) => {
            ...
            this._container.querySelector('.menu-dropdown').classList.toggle('active');
        });
    ...
    _hideTokenInput() {
        this._container.querySelector('.alternatives-token-container').classList.add('hidden');
    }
